...
<div class="btn-toolbar clearfix">
    ...
    {capture name="add_new_picker"}
        {include file="addons/sd_file_loader_for_orders/views/order_management/update.tpl" attachment=[] object_id=$object_id object_type=$object_type}
    {/capture}
...
{if $attachments}
    ...
    {foreach from=$attachments item="a"}
        {capture name="object_group"}
            {include file="addons/sd_file_loader_for_orders/views/order_management/update.tpl" attachment=$a object_id=$object_id object_type=$object_type hide_inputs=$hide_inputs}
        {/capture}
