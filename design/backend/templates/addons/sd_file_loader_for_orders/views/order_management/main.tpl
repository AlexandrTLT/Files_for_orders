...
<div class="btn-toolbar clearfix">
    ...
    {capture name="add_new_picker"}
        {include file="addons/sd_file_loader_for_orders/views/order_management/update.tpl" attachment=[] order_id=$order_id}
    {/capture}
...
{if $files}
    ...
    {foreach from=$files item="a"}
        {capture name="object_group"}
            {include file="addons/sd_file_loader_for_orders/views/order_management/update.tpl" orfile=$a order_id=$order_id hide_inputs=$hide_inputs}
        {/capture}
